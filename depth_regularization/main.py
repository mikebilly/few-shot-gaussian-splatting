from proj_utils import create_depth_maps, project_points_to_cameras, find_optimal_offset_scale, get_smoothness_loss
import cv2
import numpy as np
import os
...
depth_maps = create_depth_maps(dataset_path, save=True)
